               ...
               <div className="container-fluid" style={{paddingLeft: '50px' }}>
                   <div className="row">
                       ...
                       <div className='col-sm-5'>
                           <div className="row align-item-right" style={{paddingBottom:0,fontSize:"14px",fontWeight:"700"}}>
                               <div className="col-auto" >Reliance Industries Ltd.</div>
                               <div className="col-auto" style={{ color: '#2baae0' }}>NSE:RELIANCE</div>
                               <div className="col-auto" style={{ color: '#6c757da3' }}>BSE:326154</div>
                             </div>
                             ...
                             <div style={{fontSize:'18px',fontWeight:'bold',paddingTop:'3px'}}> 
                                <button style={{...btnStyle,width:'80px',marginRight:'5px'}}>Buy</button>
                                <button style={{...btnStyle,width:'80px',background:'#e91e63'}}>Sell</button>
                             </div>
